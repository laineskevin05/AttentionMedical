...
export const starDoctorLoaded = (uid, departamento = 'Todos') => {
  console.log(uid);
  return async (dispacth) => {
    try {
      ...
      const filtroDoctor = doctores.filter( doctor => {
        return doctor.especialidad == departamento
      })
      dispacth(doctorLoad(filtroDoctor)); 
