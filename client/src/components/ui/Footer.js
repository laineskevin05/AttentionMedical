...
const Footer = () => {
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="">
        ...
        <p>
         Te conectamos con el centro hospitalario de tu preferencia
        </p>
      </div>
      <div class="">
        ...
        <p class="mb-4">
          <a href="#!" class="text-gray-600">React JS</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">MongDB</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Express JS</a>
        </p>
        <p>
          <a href="#!" class="text-gray-600">Node JS</a>
        </p>
      </div>
      <div class="">
        <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
        ...
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Precios</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Ajustes</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Citas</a>
        </p>
        <p>
  ...
  <div className="  text-center p-6 bg-gray-200 ">
    ...
    <a className="text-gray-600 font-semibold " href="https://tailwind-elements.com/">Atencion Medica</a>
  </div>
