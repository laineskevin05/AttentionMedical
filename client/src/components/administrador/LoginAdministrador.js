...
import IconUser from "../../assets/images/AdministradorSVG.svg";

const email = new RegExp(/[^@ \t\r\n]+@[^@ \t\r\n]+\.[^@ \t\r\n]+/);
const password = new RegExp(/^(?=\w*\d)(?=\w*[A-Z])(?=\w*[a-z])\S{6,12}$/);

const LoginAdmistrador = () => {
          ...
          <div className="mb-4">
            <div className="grid w-full place-items-center">
              <img
                src={IconUser}
                alt="Icon User"
                className=" rounded-full border-2 mt-4 mb-1 p-2 fill-red-300 bg-red-200 border-gray-400"
                width="80px"
              />
            </div>
...
export default LoginAdmistrador;
